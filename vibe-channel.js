...
const CHANNELS=[
{id:'actualites',name:'VIBE — Actualités',subtitle:'Informations récentes vérifiées par VIBE AI'},
{id:'cote-ivoire',name:'VIBE — Côte d’Ivoire',subtitle:'Actualités ivoiriennes vérifiées par VIBE AI'},
{id:'monde',name:'VIBE — Monde',subtitle:'Actualités internationales vérifiées par VIBE AI'},
{id:'sports',name:'VIBE — Sports',subtitle:'Sport et compétitions vérifiés par VIBE AI'},
...
function injectChannelUI(){
  if(!document.getElementById('vibeChannelsStyle')){
    const s=document.createElement('style');s.id='vibeChannelsStyle';s.textContent=`
      ...
      .vibe-channel-item img{width:48px;height:48px;flex:0 0 48px;border-radius:50%;object-fit:cover}
      .vibe-channel-item span{min-width:0;display:flex;flex-direction:column;gap:3px}
      ...
      @media(max-width:800px){.vibe-channel-item{height:68px}.vibe-channel-item img{width:44px;height:44px;flex-basis:44px}}

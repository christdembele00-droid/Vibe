...
def test_domain_routes_require_authentication():
    paths=['/api/v1/contacts','/api/v1/devices','/api/v1/groups','/api/v1/channels','/api/v1/statuses','/api/v1/media/complete','/api/v1/security/reports','/api/v1/search/users?q=x','/api/v1/account/deletion']
    for path in paths:

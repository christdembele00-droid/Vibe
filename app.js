...
window.VibeApp={createChat,joinChat,createStory,openChat,toggleFavorite,isFavorite:chatId=>state.favorites.has(chatId),get currentChatId(){return state.currentChatId},getChats:()=>[...state.chats.values()],refreshChats:()=>scheduleChatRender()};